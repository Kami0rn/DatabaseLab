...
namespace WindowsForm1
{
    public partial class Form1 : Form
    {
        ...
        private void t_clear_data()
        {
            ...
            t_gender_male.Checked = false;
            t_gender_female.Checked = false;
        ...
        private void t_bt_cls_Click(object sender, EventArgs e)
        {
            t_clear_data();
        }
        ...
        private void load_teacher_griddata_init()
        {
            ...
            MySqlDataAdapter da = new MySqlDataAdapter(comm);
            da.Fill(ds, "Teacher");
            dataGridView1.DataSource = ds.Tables["Teacher"].DefaultView;
        ...
        {
            var t_id = t_id_input.Text;
            var t_name = t_name_input.Text;
            var gender = "";
            if (t_gender_male.Checked)
            {
                gender = t_gender_male.Text;
            }
            else
            {
                gender = t_gender_female.Text;
            }
            string dob_date = dateTimePicker1.Value.ToString("yyyy-MM-dd");

            comm = con.CreateCommand();
            comm.CommandText = "UPDATE project_database.teacher SET Teacher_name=@Teacher_name, Gender=@Gender , DOB=@DOB  WHERE Teacher_id = @Teacher_id";
        ...
        private void t_gender_male_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void t_bt_insert_Click(object sender, EventArgs e)
        {
            var t_id = t_id_input.Text;
            var t_name = t_name_input.Text;
            var t_gender = "";
            if (t_gender_male.Checked)
            {
                t_gender = t_gender_male.Text;
            }
            else
            {
                t_gender = t_gender_female.Text;
            }
            string dob_date = dateTimePicker1.Value.ToString("yyyy-MM-dd");
            ...
            comm.Parameters.AddWithValue("@Teacher_id", t_id);
            comm.Parameters.AddWithValue("@Teacher_name", t_name);
            comm.Parameters.AddWithValue("@Gender", t_gender);
            comm.Parameters.AddWithValue("@DOB", dob_date);
        ...
        private void t_bt_delete_Click(object sender, EventArgs e)
        {
            var t_id = t_id_input.Text;
        ...
        private void t_gender_female_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void t_bt_update_Click(object sender, EventArgs e)
        {
            var t_id = t_id_input.Text;
            var t_name = t_name_input.Text;
            var gender = "";
